...
var DominioService = /** @class */ (function () {
    ...
    DominioService.prototype.buscarDominio = function (domain) {
        var key = 'hDnnOl0AHJ0rF5pOdODto2Q4MEfdqCWj';
        var url = this.URL_SERVICIO + ("?key=" + key + "&domain=" + domain);
        return this.http.get(url, { headers: headers }).pipe();
    };
    DominioService.ctorParameters = function () { return [
