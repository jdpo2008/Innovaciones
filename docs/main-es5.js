...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_services_dominio_service__WEBPACK_IMPORTED_MODULE_9__["DominioService"], _services_alert_service__WEBPACK_IMPORTED_MODULE_10__["AlertService"]],
...
var ContactFormComponent = /** @class */ (function () {
    function ContactFormComponent(fb, alertaservice) {
        this.fb = fb;
    ...
    ContactFormComponent.prototype.onSubmit = function () {
        ...
        $.ajax({
            ...
            if (data.ok) {
                _this.alertaservice.setMensaje('success', 'Excelente!..', data.mensaje, 5000);
            }
            else {
                _this.alertaservice.setMensaje('error', 'Ops!..', data.mensaje, 5000);
            }
        }).fail(function (err) {
            console.log(err);
        }).always(function () {
...
var ServiceExtraComponent = /** @class */ (function () {
    function ServiceExtraComponent(dominioService, alertaservice) {
    ...
    ServiceExtraComponent.prototype.buscarDominio = function (texto, extension) {
        var _this = this;
        this.submited = true;
        if (texto === '' || extension === '') {
        ...
        this.dominioService
            ...
            .done(function (data) {
            if (data.disponible) {
                _this.alertaservice.setMensaje('success', 'Excelente!..', 'El Dominio ' + texto + extension + ' esta disponible', 5000);
            }
            else {
                _this.alertaservice.setMensaje('error', 'Ops!..', 'El Dominio ' + texto + extension + ' no esta disponible', 5000);
            }
        })
            .fail(function (err) {
            _this.alertaservice.setMensaje('error', 'Ops!..', 'Error: ' + err.status + ' Codigo: ' + err.statusText, 5000);
        })
            .always(function () {
            console.log('solicitud completa');
        });
    };
    ServiceExtraComponent.ctorParameters = function () { return [
...
var AlertService = /** @class */ (function () {
    ...
    AlertService.prototype.setMensaje = function (tipo, titulo, mensaje, duracion) {
...
var DominioService = /** @class */ (function () {
    function DominioService() {
        this.Incremento = 0;
    }
    DominioService.prototype.buscarDominio = function (texto, extension) {
        return $.ajax({
            url: 'buscador.php',
            type: 'POST',
            dataType: 'json',
